...
echo "********** $KVMSG"
echo "********** $KVMSG"
apt-get install -y --allow-unauthenticated avahi-daemon libnss-mdns traceroute htop httpie bash-completion docker-ce=5:18.09.1~3-0~ubuntu-xenial kubeadm kubelet kubectl
